...
st.markdown(
    "A tőzsdei árfolyamok mozgása közvetlenül vagy közvetve reagálhat a piacon kívüli eseményekre. A piaci reakciók megértése és vizualizálása kulcsfontosságú lehet a befektetők és elemzők számára, hogy felismerjék a piaci trendeket és segithet a kockázatok kezelésében.")

# Deepwater Horizon: 20 April 2010
st.subheader("Deepwater Horizon - olajkatasztrófa")
st.markdown(
    "A Deepwater Horizon katasztrófa 2010. április 20-án következett be a Mexikói-öbölben, amikor a BP olajfúrótornya felrobbant, és hatalmas olajszivárgás indult el a tengerfenéken. A katasztrófa hatalmas környezeti károkat okozott: a szennyezés súlyosan érintette a tengeri élővilágot, a part menti ökoszisztémákat és a halászati ipart.")
st.markdown(
    "A fúrótórony a Transocean tulajdonában állt és a BP számára végzett olajkitermelést. A katasztrófa és annak következményei jelentős hatással voltak az olajipari cégek, különösen a Transocean és a BP tőzsdei árfolyamaira. ")
...
st.markdown(
    "Az AI boom az utóbbi években új üzleti lehetőségeket teremtett a technológiai szektorban, kiemelkedő szereplőkké téve a Microsoftot és az NVIDIA-t. Az ábránk jól tükrözi az AI térnyerésének gazdasági hatásait és a technológiai szektor iránti növekvő befektetői érdeklődést.")
